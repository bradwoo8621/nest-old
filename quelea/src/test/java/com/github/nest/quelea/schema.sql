DROP TABLE T_INDIVIDUAL_AGENT IF EXISTS;
...
CREATE TABLE T_INDIVIDUAL_AGENT (
	ROLE_ID BIGINT PRIMARY KEY,
...
ALTER TABLE T_INDIVIDUAL_AGENT ADD CONSTRAINT FK_INDIVIDUAL_AGENT__1 FOREIGN KEY (ROLE_ID) REFERENCES T_PARTY_ROLE (ROLE_ID);
