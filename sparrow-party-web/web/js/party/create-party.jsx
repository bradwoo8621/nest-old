...
var TypeSelectionPanel = React.createClass({
            ...
            <Panel header="Please choose the role of party..." className={this._panelClassName}>
                <div className="row">
                    <div className="col-md-2">
                        <label htmlhtmlFor="partyTypeCode" className={this._labelClassName}>Party Type:</label>
                    </div>
                    <div className="col-md-3">
                        <Select2 id="partyTypeCode" name="partyTypeCode" options={Codes.partyTypeList}
                    ...
                    <div className="col-md-3">
                        <Select2 id="roleTypeCode" name="roleTypeCode" options={Codes.roleTypeList}
                                 model={this.getModel()}
                    ...
                    <div className="col-md-2">
                        <Button bsStyle="primary" block onClick={this.createClicked}>
                            <Glyphicon glyph="plus-sign"/> Create
                        </Button>
                    </div>
                </div>
    ...
    // party type changed
    partyTypeChanged: function () {
        this.hideWarning();
    },
    // role type changed
    roleTypeChanged: function () {
        this.hideWarning();
    },
