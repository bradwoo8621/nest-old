...
var Pagination = React.createClass({
    __classNames: {
        statusDiv: "pagination-status col-md-2",
        buttonsDiv: "col-md-10 pagination-status-buttons",
    ...
    renderStatus: function () {
        if (this.props.showStatus) {
            return (<div className={this.getCSSClass("statusDiv")}>
                <div>
    ...
    render: function () {
        ...
        return (<div className={className}>
            {this.renderStatus()}
            <div className={this.getCSSClass("buttonsDiv")}>
                <ul className={this.getCSSClass("pagination")}>
